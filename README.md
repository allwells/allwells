...
A dedicated Full Stack Developer from Nigeria with at least 4 years of experience in an assortment of technologies, including Create React App, Next.js, Tailwindcss, API integration, Typescript, etc. Possesses exceptional problem-solving skills and a self-motivated, dependable nature and can effectively self-manage during independent projects, as well as collaborate in a team setting. A goal-driven individual that focuses on achieving short- and long-term goals, and client satisfaction.
